...
import cn.edu.guet.security.GrantedAuthorityImpl;
...
public class JwtTokenUtils implements Serializable {
    ...
    public static String getUsernameFromToken(String token) {
        ...
        try {
            ...
            System.out.println("claim是否为空：" + claims);
            ...
            if (e instanceof ExpiredJwtException) {
                ...
                System.out.println("是否为空：" + username);
            }
        }
        return username;
    }
    ...
    public static Boolean validateToken(String token, String username) {
        ...
        System.out.println("username：" + username);
        boolean result = (userName.equals(username) && !isTokenExpired(token));
    ...
    public static Boolean isTokenExpired(String token) {
        try {
            ...
            System.out.println("过期了吗：" + result);
            return result;
        } catch (Exception e) {
            return false;
        }
